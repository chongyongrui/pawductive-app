...
class AuthService {
  ...
  Future registerWithEmailAndPassword(String email, String password) async{
    try{
      ...
      await DatabaseService(uid: user!.uid).updateUserData("new user", 0, 0, 1,'https://www.kindpng.com/picc/m/207-2074624_white-gray-circle-avatar-png-transparent-png.png',1);
      return _userfromFirebase(user);
